...
export const createProduct = () => async (dispatch, getState) => {
  try {
    ...
    // but still why only empty object?
    const { data } = await axios.post(`/api/products/`, {}, config) // we place an empty object coz we are making a post request but we are not sending any data here
